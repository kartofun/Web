              ...
              <div class="block__content">
                <form class="form" method="POST" action="/article.php?id=<?php echo $art['id']; ?>#comment-add-form">
                  ...
                  if( isset($_POST['do_post']) )
                  {
                    ...
                    if( $_POST['text'] == '' )
                    {
                      $errors[] = 'Введите текст коммнетария!';
                    }
                  ...
                  <div class="form__group">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <input type="text" name="nickname" class="from__control" placeholder="Никнейм" value="<?php echo $_POST['nickname']; ?>">
                      </div>
                      <div class="col-md-4">
                        <input type="text" name="email" class="from__control" placeholder="Email (не будет показан)" value="<?php echo $_POST['email']; ?>">
                      </div>
                    </div>
                  </div>
